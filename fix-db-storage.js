...
console.log('Fixing database storage TypeScript null check errors...');
...
try {
  ...
  console.log('Database storage file updated with proper null checks');
} catch (error) {
  console.error('Failed to update database storage file:', error.message);
  process.exit(1);
}